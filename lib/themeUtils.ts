  ...
  switch (theme) {
    case 'white':
      return {
        ...
        activeTabBg: 'bg-emerald-200/90 text-emerald-950 border border-emerald-400/60 font-extrabold',
    ...
    case 'dark':
      return {
        ...
        activeTabBg: 'bg-slate-700/90 text-white border border-slate-400/60 font-extrabold',
    ...
    case 'cyan':
      return {
        ...
        activeTabBg: 'bg-sky-200/95 text-cyan-950 border border-sky-400/60 font-extrabold',
    ...
    case 'green':
      return {
        ...
        activeTabBg: 'bg-emerald-200/95 text-emerald-950 border border-emerald-400/60 font-extrabold',
        buttonAccent: 'bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-md shadow-emerald-600/20',
    ...
    default:
      return {
        ...
        activeTabBg: 'bg-amber-200/95 text-amber-950 border border-amber-400/60 font-extrabold',
