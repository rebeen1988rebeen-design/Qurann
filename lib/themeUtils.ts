  ...
  switch (theme) {
    case 'white':
      return {
        ...
        navGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-slate-900 rounded-[32px]',
        playerGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-slate-900 rounded-[32px]',
    ...
    case 'dark':
      return {
        ...
        navGlass: 'bg-black/[0.08] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.3)] shadow-2xl text-white rounded-[32px]',
        playerGlass: 'bg-black/[0.08] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.3)] shadow-2xl text-white rounded-[32px]',
    ...
    case 'cyan':
      return {
        ...
        navGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-cyan-950 rounded-[32px]',
        playerGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-cyan-950 rounded-[32px]',
    ...
    case 'green':
      return {
        ...
        navGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-emerald-950 rounded-[32px]',
        playerGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-emerald-950 rounded-[32px]',
    ...
    case 'yellow':
      return {
        ...
        navGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-amber-950 rounded-[32px]',
        playerGlass: 'bg-white/[0.04] backdrop-blur-sm backdrop-saturate-200 border border-white/30 shadow-[inset_0_1.5px_1px_0_rgba(255,255,255,0.8),inset_0_-1px_1px_0_rgba(255,255,255,0.2),0_20px_40px_rgba(0,0,0,0.1)] shadow-2xl text-amber-950 rounded-[32px]',
