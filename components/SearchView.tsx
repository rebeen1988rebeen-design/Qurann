                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">
                        {surah.name} • {t.pageBadge} {toLocalizedNumeral(surah.page, appLanguage)} • {surah.numberOfAyahs} {t.verses}
                      </div>
                    </div>
                  </div>
              ...
              {matchingVerses.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div dir="rtl" className="text-lg uthmani-text mb-2 text-slate-900 dark:text-white leading-relaxed">
